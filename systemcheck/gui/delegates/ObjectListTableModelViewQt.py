...
from systemcheck.gui.delegates import ComboBoxDelegateQt, CheckBoxDelegateQt, FloatEditDelegateQt, DateTimeEditDelegateQt, \
    FileDialogDelegateQt, PushButtonDelegateQt
