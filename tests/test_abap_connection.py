...
class TestConnection(TestCase):
    ...
    def test_clients(self):
        ...
        self.assertEqual(result.data, {'data': [{'MANDT': '000', 'MTEXT': 'SAP AG Konzern'},
                                                {'MANDT': '001', 'MTEXT': 'SAP AG Konzern'}], 'headers': ['MANDT', 'MTEXT']})
    ...
    def test_call_fm(self):
        ...
        expected_result = {'CURRENT_RESOURCES': 2,
                           'MAXIMAL_RESOURCES': 3,
                           'RECOMMENDED_DELAY': 0,
                           'RFCSI_EXPORT': {'RFCCHARTYP': '4103', 'RFCDATABS': 'NPL', 'RFCDAYST': '', 'RFCDBHOST': 'abap001',
                                            ...
                                            'RFCSAPRL': '750', 'RFCSI_RESV': '', 'RFCSYSID': 'NPL', 'RFCTZONE': '     0'}}
